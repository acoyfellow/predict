...
<span class="key">action</span>: <span class="str">"returning_customer"</span></code></pre>
    ...
    <p>Predict sends a small page and session state. Here is the default payload at a glance.</p>
    <div class="signal-table-wrap"><table><thead><tr><th>Signal</th><th>What it means</th></tr></thead><tbody><tr><td>Page</td><td>Path, title, and page type</td></tr><tr><td>Session</td><td>Time on page, page count, and referrer category</td></tr><tr><td>Engagement</td><td>Scroll, clicks, keys, and CTA interaction</td></tr><tr><td>Motion</td><td>Idle time, visibility, exit intent, and rage clicks</td></tr><tr><td>Form</td><td>Safe progress state, never field values</td></tr><tr><td>Metadata</td><td>Only explicit customer context</td></tr></tbody></table></div>
    <p>It does not send a user agent, referrer URL, page text, form values, keystrokes, mouse coordinates, cookies, or a fingerprint in the prediction body.</p>
    <h2>Built on</h2>
    <div class="stack-logos"><a href="https://workers.cloudflare.com/" target="_blank" rel="noreferrer"><img class="cloudflare-mark" src="/cloudflare-logo.svg" alt="Cloudflare" /><span>Cloudflare<br /><small>Workers · Workers AI · AI Gateway</small></span></a><a href="https://typesafe.ai/" target="_blank" rel="noreferrer"><img class="typesafe-mark" src="/typesafe-logo.png" alt="TypeSafe" /><span>TypeSafe<br /><small>Jev prediction model</small></span></a></div>
